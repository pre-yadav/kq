...
@javax.inject.Named("subProcess1")
@io.quarkus.runtime.Startup()
public class SubProcess1Process extends org.kie.kogito.process.impl.AbstractProcess<org.acme.travels.SubProcess1Model> {

    @javax.inject.Inject()
    org.kie.kogito.process.Process<TimersOnTaskModel> processtimersOnTask;

    @javax.inject.Inject()
    public SubProcess1Process(org.kie.kogito.app.Application app) {
        super(app, java.util.Arrays.asList());
        activate();
    }

    public SubProcess1Process() {
    }

    @Override()
    public org.acme.travels.SubProcess1ProcessInstance createInstance(org.acme.travels.SubProcess1Model value) {
        return new org.acme.travels.SubProcess1ProcessInstance(this, value, this.createProcessRuntime());
    }

    public org.acme.travels.SubProcess1ProcessInstance createInstance(java.lang.String businessKey, org.acme.travels.SubProcess1Model value) {
        return new org.acme.travels.SubProcess1ProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    @Override()
    public org.acme.travels.SubProcess1Model createModel() {
        return new org.acme.travels.SubProcess1Model();
    }

    public org.acme.travels.SubProcess1ProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((org.acme.travels.SubProcess1Model) value);
    }

    public org.acme.travels.SubProcess1ProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (org.acme.travels.SubProcess1Model) value);
    }

    public org.acme.travels.SubProcess1ProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.acme.travels.SubProcess1ProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public org.acme.travels.SubProcess1ProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.acme.travels.SubProcess1ProcessInstance(this, this.createModel(), wpi);
    }

    public org.kie.api.definition.process.Process process() {
        RuleFlowProcessFactory factory = RuleFlowProcessFactory.createProcess("subProcess1");
        factory.variable("type2", new ObjectDataType("java.lang.String", org.acme.travels.SubProcess1Process.class.getClassLoader()), "customTags", null);
        factory.name("sb");
