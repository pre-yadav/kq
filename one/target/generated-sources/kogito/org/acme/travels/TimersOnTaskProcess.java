...
public class TimersOnTaskProcess extends org.kie.kogito.process.impl.AbstractProcess<org.acme.travels.TimersOnTaskModel> {
    ...
    @Override()
    public org.acme.travels.TimersOnTaskProcessInstance createInstance(org.acme.travels.TimersOnTaskModel value) {
        return new org.acme.travels.TimersOnTaskProcessInstance(this, value, this.createProcessRuntime());
    }

    public org.acme.travels.TimersOnTaskProcessInstance createInstance(java.lang.String businessKey, org.acme.travels.TimersOnTaskModel value) {
        return new org.acme.travels.TimersOnTaskProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    @Override()
    public org.acme.travels.TimersOnTaskModel createModel() {
        return new org.acme.travels.TimersOnTaskModel();
    }

    public org.acme.travels.TimersOnTaskProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((org.acme.travels.TimersOnTaskModel) value);
    }

    public org.acme.travels.TimersOnTaskProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (org.acme.travels.TimersOnTaskModel) value);
    }

    public org.acme.travels.TimersOnTaskProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.acme.travels.TimersOnTaskProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public org.acme.travels.TimersOnTaskProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new org.acme.travels.TimersOnTaskProcessInstance(this, this.createModel(), wpi);
    }
    ...
    public org.kie.api.definition.process.Process process() {
        ...
        factory.variable("delay2", new ObjectDataType("java.lang.String", org.acme.travels.TimersOnTaskProcess.class.getClassLoader()), "customTags", "input");
