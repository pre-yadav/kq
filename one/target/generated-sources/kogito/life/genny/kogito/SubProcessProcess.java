...
public class SubProcessProcess extends org.kie.kogito.process.impl.AbstractProcess<life.genny.kogito.SubProcessModel> {
    ...
    @Override()
    public life.genny.kogito.SubProcessProcessInstance createInstance(life.genny.kogito.SubProcessModel value) {
        return new life.genny.kogito.SubProcessProcessInstance(this, value, this.createProcessRuntime());
    }

    public life.genny.kogito.SubProcessProcessInstance createInstance(java.lang.String businessKey, life.genny.kogito.SubProcessModel value) {
        return new life.genny.kogito.SubProcessProcessInstance(this, value, businessKey, this.createProcessRuntime());
    }

    @Override()
    public life.genny.kogito.SubProcessModel createModel() {
        return new life.genny.kogito.SubProcessModel();
    }

    public life.genny.kogito.SubProcessProcessInstance createInstance(org.kie.kogito.Model value) {
        return this.createInstance((life.genny.kogito.SubProcessModel) value);
    }

    public life.genny.kogito.SubProcessProcessInstance createInstance(java.lang.String businessKey, org.kie.kogito.Model value) {
        return this.createInstance(businessKey, (life.genny.kogito.SubProcessModel) value);
    }

    public life.genny.kogito.SubProcessProcessInstance createInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new life.genny.kogito.SubProcessProcessInstance(this, this.createModel(), this.createProcessRuntime(), wpi);
    }

    public life.genny.kogito.SubProcessProcessInstance createReadOnlyInstance(org.kie.api.runtime.process.WorkflowProcessInstance wpi) {
        return new life.genny.kogito.SubProcessProcessInstance(this, this.createModel(), wpi);
    }
    ...
    public org.kie.api.definition.process.Process process() {
        ...
        factory.variable("type2", new ObjectDataType("java.lang.String", life.genny.kogito.SubProcessProcess.class.getClassLoader()), "customTags", null);
        factory.name("sb");
        ...
        subProcessNode2.subProcessNode(new org.jbpm.workflow.core.node.SubProcessFactory<TimersOnTaskModel>() {
            ...
            public TimersOnTaskModel bind(org.kie.api.runtime.process.ProcessContext kcontext) {
                life.genny.kogito.TimersOnTaskModel model = new life.genny.kogito.TimersOnTaskModel();
                java.lang.String type2 = (java.lang.String) kcontext.getVariable("type2");
